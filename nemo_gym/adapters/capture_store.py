    ...
    for exchange in exchanges:
        ...
        output.append(
            NeMoGymResponseOutputMessageForTraining(
                ...
                status="completed",
                type="message",
                prompt_token_ids=message.get("prompt_token_ids") or [],
                generation_token_ids=message.get("generation_token_ids") or [],
                generation_log_probs=message.get("generation_log_probs") or [],
            )
        )
        assistant_index += 1
